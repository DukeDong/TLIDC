...
%input dir
s_inputdir = 'D:\Data\feret';

%parameters for TLIDC
n_clsnum = 20;      %Cluster Number
d_delta1 = 0.2;     %¦¤ in TLIDC
d_delta2 = 0.1;     %¦Ä in TLIDC
...
%load all images and labels in memory
%different classes of images should be stored in folders seperately
%e.g.
%s_inputdir
%       |_class_1name
%           |_1.jpg(no rules for image names)
%           |_...
%       |_class_2name
%           |_...
%       ¡­¡­
st_imglst = db_gainallfiles(s_inputdir,'*.tif'); %make sure formats of images are the same
[m_data,v_id] = db_gainid_q(st_imglst,n_clsnum);
